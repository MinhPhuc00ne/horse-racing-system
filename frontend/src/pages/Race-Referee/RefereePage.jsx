...
function RefereeDashboardContent() {
  ...
  return (
    <div className="dashboard-wrapper p-0">
      ...
      <div className="mb-4">
        ...
        <h2 className="ho-font-epilogue fs-3 fw-bold text-dark mb-1">Race Referee Panel</h2>
        <p className="text-secondary small">Access referee information and perform Security Role checks.</p>
      </div>
          ...
          <div className="test-panel">
            <div>
              ...
              <p className="panel-description text-secondary">
                Trigger endpoint requests to verify Spring Security role restrictions. Under a <strong>RACE_REFEREE</strong> role, 
                you should be allowed to access <code>/public</code>, <code>/referee</code>, and <code>/any-role</code>, but blocked (403) from others.
              </p>
            </div>

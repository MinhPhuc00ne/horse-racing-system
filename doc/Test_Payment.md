...
- Chạy lệnh sau:
  ...
  ```
  *(Lưu ý: Dùng localhost.run tốt hơn Ngrok vì Ngrok miễn phí hay có màn hình chặn làm PayOS bị lỗi).*
- Sau khi chạy, nó sẽ in ra một đường link, ví dụ: `https://567fb3b9805551.lhr.life`. Hãy copy link này. (Tuyệt đối không tắt tab Terminal này).
...
## 3. LUỒNG TEST: NẠP TIỀN (DEPOSIT) BẰNG POSTMAN

**Bước 1: Kiểm tra số dư ban đầu**
- **Method:** `GET`
